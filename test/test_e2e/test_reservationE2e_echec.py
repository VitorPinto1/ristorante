...
try:
    ...
    try:
        ...
        driver.execute_script("arguments[0].value = '2024-07-08';", date_input)
        ...
        # Wait for the error message indicating the reservation is on Monday
        error_message = WebDriverWait(driver, 10).until(
            EC.presence_of_element_located((By.ID, "mondayWarning"))
        )
        print("Reservation test succeeded! Reservation was not sent because the date was on Monday.")
